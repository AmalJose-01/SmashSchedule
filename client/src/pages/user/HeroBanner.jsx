  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-blue-900 via-blue-800 to-purple-900  shadow-2xl mb-8 rounded-xl">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url(https://images.unsplash.com/photo-1613918431551-b2ef2720387c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxiYWRtaW50b24lMjBwbGF5ZXIlMjBhY3Rpb258ZW58MXx8fHwxNzY1NzAxNzY4fDA&ixlib=rb-4.1.0&q=80&w=1080)",
      ...
      <div className="relative z-10 px-8 py-12 md:px-12 md:py-16">
        <div className="max-w-4xl">
          ...
          <p className="text-base md:text-lg text-blue-200 mb-8 max-w-3xl leading-relaxed">
            Comprehensive tournament management solution for badminton clubs and
            organizers. Create tournaments, manage registrations, schedule
            matches, track scores, and generate knockout brackets - all in one
            powerful platform.
          </p>
