...
router.put("/update-tournament", auth, adminTeamController.updateTournament);

router.get("/get-tournaments", auth, adminTeamController.getTournaments);
router.get(
  "/get-tournament-information/:tournamentId",
  auth,
  adminTeamController.getTournamentInformation
);
...
router.get(
  "/get-tournamentDetails/:tournamentId",
  auth,
  adminTeamController.getTournamentDetails
);
router.post("/save-score", auth, adminTeamController.saveMatchScore);
router.post(
  "/save-multiple-score",
  auth,
  adminTeamController.saveMultipleMatchScore
);

router.delete(
  "/delete-tournament/:tournamentId",
  auth,
  adminTeamController.deleteTournament
);
